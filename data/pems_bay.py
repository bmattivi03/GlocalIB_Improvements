"""
Preprocessing func for the dataset pems_bay .
...
def load_pems_bay(local_path):
    """Load dataset pems_bay.

    Parameters
    ----------
    local_path : str,
        The local path of dir saving the raw data of pems_bay.

    Returns
    -------
    data : dict
        A dictionary contains the time-series data of pems_bay.
    """
    file_path = os.path.join(local_path, "pems_bay.h5")
...
def preprocess_pems_bay(
    rate,
    n_steps,
    pattern: str = "point",
    **kwargs,
) -> dict:
    """Load and preprocess the dataset pems_bay.
    ...
    -------
    processed_dataset :
        A dictionary containing the processed pems_bay.
    """
    ...
    data = load_pems_bay("/root/work/myModel/data/all_datasets/pems_bay")
